    ...
    <div>
      ...
      <div style={{ padding: 20, maxWidth: 700, margin: '0 auto' }}>
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          ...
          <input name="studentName" required style={{ width: '100%', marginBottom: 10 }} />

          <label>Student's Date of Birth*</label>
          <input type="date" name="studentDob" required style={{ width: '100%', marginBottom: 10 }} />

          <label>Student's Class*</label>
          <input name="classLevel" required style={{ width: '100%', marginBottom: 10 }} />

          <label>Parent/Guardian's Full Name*</label>
          <input name="parentName" required style={{ width: '100%', marginBottom: 10 }} />

          <label>Emergency Contact's Name*</label>
          <input name="emergencyName" required style={{ width: '100%', marginBottom: 10 }} />

          <label>Emergency Contact's Phone Number*</label>
          <input name="emergencyPhone" required style={{ width: '100%', marginBottom: 10 }} />
          ...
          <button type="button" onClick={() => sigCanvas.current && sigCanvas.current.clear()} style={{ marginRight: 8 }}>Clear Signature</button>
